...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    HELLDIVER_ARMOR_MATERIAL("helldiver", 37, Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266655_) -> {
    ...
    }), 15, SoundEvents.ARMOR_EQUIP_NETHERITE, 4.0F, 0.1F, () -> Ingredient.of(ModItems.TITANIUM.get()));
