...
//        TintPostProcessor.INSTANCE.setActive(true);
        isFlashed = true;
        PacketHandler.sendToServer(new SSphereExplosionPacket(pContext.getClickedPos(), 30));
...
//            }
            ...
            WorldParticleBuilder.create(LodestoneParticleRegistry.WISP_PARTICLE)
                    ...
                    .setLifetime(600)
                    .addMotion(dx / 5, dy / 5, dz / 5)
                    .spawn(level, pos.x, pos.y - 10, pos.z);

            // Flash Particle
            WorldParticleBuilder.create(LodestoneParticleRegistry.WISP_PARTICLE)
                    .setScaleData(GenericParticleData.create(2.5f, 175f).build())
        ...
        ModClientEvents.triggerFlashEffect();
