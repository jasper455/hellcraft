...
public class StalwartItem extends Item implements GeoItem, IGunItem {
    ...
    private static final int SHOOT_DELAY = 1; // This will give you about 600 RPM


    public StalwartItem(Properties properties) {
        super(new Properties().durability(202).rarity(Rarity.COMMON));
    }
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        ...
        consumer.accept(new IClientItemExtensions() {
            private final BlockEntityWithoutLevelRenderer renderer = new StalwartRenderer();
            ...
            private static final HumanoidModel.ArmPose StalwartPose = HumanoidModel.ArmPose.create("Stalwart",
    ...
    public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
        ...
        list.add(Component.literal("§e[Machine-Gun]"));
