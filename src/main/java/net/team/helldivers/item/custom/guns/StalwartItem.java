...
public class StalwartItem extends AbstractGunItem {
    ...
    public StalwartItem(Properties properties) {
        super(properties.durability(202).rarity(Rarity.COMMON), 2.5f, true, true, "§e[Machine-Gun]", 1, 2, 0.05,  ModSounds.STALWART_SHOOT, ModSounds.AR_23_RELOAD);
    }

    @Override
    public BlockEntityWithoutLevelRenderer createRenderer() {
        return new StalwartRenderer();
    }
}