...
public class AmrItem extends AbstractGunItem {
    public AmrItem(Properties properties) {
        super(properties.durability(8).rarity(Rarity.COMMON), true, "§e[Sniper-Rifle]", 25, new AmrRenderer());
    }
   
}

/*public class AmrItem extends Item implements GeoItem, IGunItem {
    ...
    private static final int SHOOT_DELAY = 25; // This will give you about 600 RPM
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        ...
        consumer.accept(new IClientItemExtensions() {
            private final BlockEntityWithoutLevelRenderer renderer = new AmrRenderer();
            ...
            private static final HumanoidModel.ArmPose AmrPose = HumanoidModel.ArmPose.create("Amr", false, (model, entity, arm) -> {
    ...
    public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
        ...
        list.add(Component.literal("§e[Sniper-Rifle]"));
