...
public class HeatedGasProjectileRenderer extends EntityRenderer<HeatedGasProjectileEntity> {
    private BulletProjectileModel model;

    public HeatedGasProjectileRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
    ...
    @Override
    public void render(HeatedGasProjectileEntity pEntity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        poseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(HeatedGasProjectileEntity bulletProjectileEntity) {
