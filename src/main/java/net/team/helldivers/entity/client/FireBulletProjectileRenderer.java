...
public class FireBulletProjectileRenderer extends EntityRenderer<FlameBulletEntity> {
    private FireBulletProjectileModel model;

    public FireBulletProjectileRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
