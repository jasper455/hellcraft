...
public class HeatedGasProjectileModel extends EntityModel<HeatedGasProjectileEntity> {
    private final ModelPart bullet;

    public HeatedGasProjectileModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(HeatedGasProjectileEntity bulletProjectileEntity, float v, float v1, float v2, float v3, float v4) {
