...
public class StratagemOrbProjectileRenderer extends EntityRenderer<StratagemOrbEntity> {
    ...
    private float[] getBeamColor(String stratagemType) {
        return switch (stratagemType) {
            ...
            case "Stalwart" -> new float[]{0.51f, 0.996f, 1.0f, 1.0f}; // Support blue color
            case "Anti-Materiel Rifle" -> new float[]{0.51f, 0.996f, 1.0f, 1.0f}; // Support blue color
            case "Portable Hellbomb" -> new float[]{0.51f, 0.996f, 1.0f, 1.0f}; // Support blue color
