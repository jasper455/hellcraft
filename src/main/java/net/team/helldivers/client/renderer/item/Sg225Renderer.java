...
import net.team.helldivers.client.model.item.P2Model;
import net.team.helldivers.client.model.item.Sg225Model;
...
public class Sg225Renderer extends GeoItemRenderer<Sg225Item> {
    public Sg225Renderer() {
        super(new Sg225Model()); // Use your custom model instead of DefaultedItemGeoModel
    }

    @Override
    public RenderType getRenderType(Sg225Item animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    protected Sg225Item animatable;
    ...
    @Override
    public void actuallyRender(PoseStack matrixStackIn, Sg225Item animatable, BakedGeoModel model, RenderType type, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, boolean isRenderer, float partialTicks, int packedLightIn,
    ...
    @Override
    public void renderRecursively(PoseStack stack, Sg225Item animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn,
    ...
    @Override
    public ResourceLocation getTextureLocation(Sg225Item instance) {
