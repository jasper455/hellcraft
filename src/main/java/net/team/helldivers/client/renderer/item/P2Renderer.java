...
public class P2Renderer extends GeoItemRenderer<P2Item> {
    public P2Renderer() {
        super(new P2Model()); // Use your custom model instead of DefaultedItemGeoModel
    }

    @Override
    public RenderType getRenderType(P2Item animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    @Override
    public void actuallyRender(PoseStack matrixStackIn, P2Item animatable, BakedGeoModel model, RenderType type, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, boolean isRenderer, float partialTicks, int packedLightIn,
    ...
    @Override
    public void renderRecursively(PoseStack stack, P2Item animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn,
    ...
    @Override
    public ResourceLocation getTextureLocation(P2Item instance) {
