...
import net.team.helldivers.client.model.item.Plas1Model;
...
public class Plas1Renderer extends GeoItemRenderer<Plas1Item> {
    public Plas1Renderer() {
        super(new Plas1Model()); // Use your custom model instead of DefaultedItemGeoModel
    }

    @Override
    public RenderType getRenderType(Plas1Item animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    protected Plas1Item animatable;
    ...
    @Override
    public void actuallyRender(PoseStack matrixStackIn, Plas1Item animatable, BakedGeoModel model, RenderType type, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, boolean isRenderer, float partialTicks, int packedLightIn,
    ...
    @Override
    public void renderRecursively(PoseStack stack, Plas1Item animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, float red,
    ...
    @Override
    public ResourceLocation getTextureLocation(Plas1Item instance) {
