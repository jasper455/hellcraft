...
import net.team.helldivers.client.model.item.StalwartModel;
...
public class StalwartRenderer extends GeoItemRenderer<StalwartItem> {
    public StalwartRenderer() {
        super(new StalwartModel()); // Use your custom model instead of DefaultedItemGeoModel
    }

    @Override
    public RenderType getRenderType(StalwartItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
    ...
    protected StalwartItem animatable;
    ...
    @Override
    public void actuallyRender(PoseStack matrixStackIn, StalwartItem animatable, BakedGeoModel model, RenderType type, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, boolean isRenderer, float partialTicks, int packedLightIn,
    ...
    @Override
    public void renderRecursively(PoseStack stack, StalwartItem animatable, GeoBone bone, RenderType type, MultiBufferSource buffer, VertexConsumer bufferIn, boolean isReRender, float partialTick, int packedLightIn, int packedOverlayIn, float red,
    ...
    @Override
    public ResourceLocation getTextureLocation(StalwartItem instance) {
