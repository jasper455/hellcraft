...
public class AmrHud {
    ...
    public static void renderAmrHud(GuiGraphics guiGraphics, int slotIndex) {
        if (slotIndex == 0) {
            imgHeight = 12;
            translateHeight = 10;
            textHeight = 12;
        ...
        if (isJammed) {
            ...
            guiGraphics.blit(StratagemHudOverlay.AMR,
        ...
        guiGraphics.drawString(Minecraft.getInstance().font, isJammed ? "§kANTI-MATERIEL RIFLE" : "ANTI-MATERIEL RIFLE", 35, textHeight, 0xFFFFFF);
        ...
        if (!isJammed) {
            ...
            StratagemHudOverlay.renderDownArrow(guiGraphics, 75, arrowHeight, 10, 10,
