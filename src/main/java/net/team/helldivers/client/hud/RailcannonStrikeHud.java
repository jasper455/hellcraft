...
public class RailcannonStrikeHud {
    ...
    public static void renderRailcannonStrikeHud(GuiGraphics guiGraphics, int slotIndex) {
        if (slotIndex == 0) {
            imgHeight = 12;
            translateHeight = 10;
            textHeight = 12;
        ...
        if (isJammed) {
            ...
            guiGraphics.blit(StratagemHudOverlay.RAILCANNON_STRIKE,
        ...
        guiGraphics.drawString(Minecraft.getInstance().font, isJammed ? "§kORBITAL RAILCANNON STRIKE" : "ORBITAL RAILCANNON STRIKE", 35, textHeight, 0xFFFFFF);
