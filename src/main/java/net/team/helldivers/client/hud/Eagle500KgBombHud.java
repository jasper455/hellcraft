...
public class Eagle500KgBombHud {
    ...
    public static void render500KgBombHud(GuiGraphics guiGraphics, int slotIndex) {
        if (slotIndex == 0) {
            imgHeight = 12;
            translateHeight = 10;
            textHeight = 12;
        ...
        if (isJammed) {
            ...
            guiGraphics.blit(StratagemHudOverlay.EAGLE_500KG_BOMB,
        ...
        guiGraphics.drawString(Minecraft.getInstance().font, isJammed ? "§kEAGLE 500KG BOMB" : "EAGLE 500KG BOMB", 35, textHeight, 0xFFFFFF);
