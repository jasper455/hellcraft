...
public class StalwartHud {
    ...
    public static void renderStalwartHud(GuiGraphics guiGraphics, int slotIndex) {
        if (slotIndex == 0) {
            imgHeight = 12;
            translateHeight = 10;
            textHeight = 12;
        ...
        if (isJammed) {
            ...
            guiGraphics.blit(StratagemHudOverlay.STALWART,
        ...
        guiGraphics.drawString(Minecraft.getInstance().font, isJammed ? "§kSTALWART" : "STALWART", 35, textHeight, 0xFFFFFF);
        ...
        if (!isJammed) {
            ...
            StratagemHudOverlay.renderLeftArrow(guiGraphics, 45, arrowHeight, 10, 10,
            ...
            StratagemHudOverlay.renderLeftArrow(guiGraphics, 85, arrowHeight, 10, 10,
