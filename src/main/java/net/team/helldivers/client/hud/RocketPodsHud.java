...
public class RocketPodsHud {
    ...
    public static void renderRocketPodsHud(GuiGraphics guiGraphics, int slotIndex) {
        if (slotIndex == 0) {
            imgHeight = 12;
            translateHeight = 10;
            textHeight = 12;
        ...
        if (isJammed) {
            ...
            guiGraphics.blit(StratagemHudOverlay.ROCKET_PODS,
        ...
        guiGraphics.drawString(Minecraft.getInstance().font, isJammed ? "§kEAGLE 110MM ROCKET PODS" : "EAGLE 110MM ROCKET PODS", 35, textHeight, 0xFFFFFF);
