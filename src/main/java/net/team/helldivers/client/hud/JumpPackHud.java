...
public class JumpPackHud {
    ...
    public static void renderJumpPackHud(GuiGraphics guiGraphics, int slotIndex) {
        if (slotIndex == 0) {
            imgHeight = 12;
            translateHeight = 10;
            textHeight = 12;
        ...
        if (isJammed) {
            ...
            guiGraphics.blit(StratagemHudOverlay.JUMP_PACK,
        ...
        guiGraphics.drawString(Minecraft.getInstance().font, isJammed ? "§kJump Pack" : "Jump Pack", 35, textHeight, 0xFFFFFF);
    ...
    public static void renderCooldownHud(GuiGraphics guiGraphics, int cooldownLeft) {
        ...
        if (!isJammed) {
            guiGraphics.drawString(Minecraft.getInstance().font, StratagemHudOverlay.percentageToTime(cooldownLeft, 8, 0),
