...
public class PortableHellbombHud {
    ...
    public static void renderPortableHellbombHud(GuiGraphics guiGraphics, int slotIndex) {
        if (slotIndex == 0) {
            imgHeight = 12;
            translateHeight = 10;
            textHeight = 12;
        ...
        if (isJammed) {
            ...
            guiGraphics.blit(StratagemHudOverlay.PORTABLE_HELLBOMB,
        ...
        guiGraphics.drawString(Minecraft.getInstance().font, isJammed ? "§kPORTABLE HELLBOMB" : "PORTABLE HELLBOMB", 35, textHeight, 0xFFFFFF);
