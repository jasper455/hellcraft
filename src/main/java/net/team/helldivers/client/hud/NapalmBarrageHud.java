...
public class NapalmBarrageHud {
    ...
    public static void renderNapalmBarrageHud(GuiGraphics guiGraphics, int slotIndex) {
        if (slotIndex == 0) {
            imgHeight = 12;
            translateHeight = 10;
            textHeight = 12;
        ...
        if (isJammed) {
            ...
            guiGraphics.blit(StratagemHudOverlay.NAPALM_BARRAGE,
        ...
        guiGraphics.drawString(Minecraft.getInstance().font, isJammed ? "§kORBITAL NAPALM BARRAGE" : "ORBITAL NAPALM BARRAGE", 35, textHeight, 0xFFFFFF);
        ...
        if (!isJammed) {
            ...
            StratagemHudOverlay.renderUpArrow(guiGraphics, 85, arrowHeight, 10, 10,
