...
public class EagleAirstrikeHud {
    ...
    public static void renderEagleAirstrikeHud(GuiGraphics guiGraphics, int slotIndex) {
        if (slotIndex == 0) {
            imgHeight = 12;
            translateHeight = 10;
            textHeight = 12;
        ...
        if (isJammed) {
            ...
            guiGraphics.blit(StratagemHudOverlay.EAGLE_AIRSTRIKE,
        ...
        guiGraphics.drawString(Minecraft.getInstance().font, isJammed ? "§kEAGLE AIRSTRIKE" : "EAGLE AIRSTRIKE", 35, textHeight, 0xFFFFFF);
